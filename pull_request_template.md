## SpecSync Pull Request Template

### Description
### Performance Impact Assessment
- [ ] **Memory:** Does this change introduce new heap allocations in the `Tick()` loop? (Target: No)
- [ ] **Latency:** Estimated execution time of the new logic (Target: < 0.1ms).
...
- [ ] Logic Engine / Math Optimization
- [ ] Bug Fix / Documentation

### Testing Performed
---
*By checking the boxes above, I confirm that I have read the [CONTRIBUTING.md] and [LICENSE] files.*